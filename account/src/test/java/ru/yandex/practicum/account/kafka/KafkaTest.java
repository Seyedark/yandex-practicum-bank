package ru.yandex.practicum.account.kafka;
...
import ru.yandex.practicum.account.TestKafkaConfig;
...
import ru.yandex.practicum.account.service.NotificationService;
...
public class KafkaTest extends SpringBootPostgreSQLBase {
    ...
    void shouldSendNotificationSuccessfully() {
        ...
        try (Consumer<String, NotificationEmailRequestDto> consumer =
            ...
            consumer.subscribe(List.of("account-notification-topic"));
